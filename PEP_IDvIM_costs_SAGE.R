...
postscript(file="figs/costs_IM_per_patient.eps", width=4.4, height=4, horizontal=F)
#par(cex=0.5, lwd=0.5, plt=c(0.1, 0.5, 0.1, 0.9), mgp=c(1.2,0.2,0), tck=-0.01)
par(cex=0.7, lwd=0.5, plt=c(0.35, 0.95, 0.1, 0.9), mgp=c(1.2,0.2,0), tck=-0.01)
plot(patients, rep(NA, length(patients)), ylim=c(0,250*prabies), type="l", lwd=2, log="x", axes=FALSE,
     xlab="Monthly clinic throughput (new bite patients)",
     ylab="Direct medical costs (in USD) per patient treated")
axis(2, lwd=0.5); axis(1, lwd=0.5)
text(30, 250*prabies, "0.5mL or 1mL vials", font=2)
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="blue")
lines(patients, costPRDA[8,], col="dark blue", lwd=2)
text(100, 175*prabies, "1-week IM", col="dark blue")
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="light blue")
lines(patients, costPRDA[9,], col="blue", lwd=2)
text(100, 150*prabies, "2-visit IM", col="blue")

# ID -  TRC4 (dark red)
lines(patients, costPRDA1insulin[1,], col="dark red", lwd=1, lty=2)
lines(patients, costPRDAinsulin[1,], col="dark red", lwd=1, lty=2)
text(100, 100*prabies, "Updated TRC 0.5mL", col="dark red")
text(100, 65*prabies, "Updated TRC 1mL", col="dark red")
...
postscript(file="figs/costs_ID_per_patient.eps", width=4.4, height=4, horizontal=F)
par(cex=0.5, lwd=0.5, plt=c(0.1, 0.5, 0.1, 0.9), mgp=c(1.2,0.2,0), tck=-0.01)
plot(patients, rep(NA, length(patients)), ylim=c(0,250*prabies), type="l", lwd=2, log="x", axes=FALSE,
     xlab="Monthly clinic throughput (new bite patients)",
     ylab="Direct medical costs (in USD) per patient treated")
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="red")
lines(patients, costPRDAwaste[1,], col="dark red", lwd=2)
text(150, 140*prabies, "Updated TRC", col="dark red")
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="indianred1")
lines(patients, costPRDAwaste[6,], col="dark red", lwd=2)
text(150, 34, "1 week ID", col="dark red")
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="tan1")
lines(patients, costPRDAwaste[4,], col="darkorange2", lwd=2)
text(150, 120*prabies, "4-site ID", col="darkorange2")
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="pink")
lines(patients, costPRDAinsulin[7,], col="indianred1", lwd=2)
text(150, 17, "IPC", col="indianred1")
...
plot(patients, rep(NA, length(patients)), ylim=c(0,250*prabies), type="l", lwd=2, log="x", axes=FALSE,
     xlab="Monthly clinic throughput (new bite patients)",
     ylab="Direct medical costs (in USD) per patient treatted")
axis(2, lwd=0.5); axis(1, lwd=0.5)
text(30, 250*prabies, "0.5mL vials", font=2)
...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="pink")
lines(patients, costPRDAinsulin[7,], col="indianred1", lwd=2)
text(150, 95*prabies, "IPC", col="indianred1")
...
########################################################################
# COMPARE ID - 1mL syringes - show overlapping lines
postscript(file="figs/ID_1ml_SAGE_figure.eps", width=4.4, height=4, horizontal=F)
par(cex=0.7, lwd=0.5, plt=c(0.35, 0.95, 0.1, 0.9), mgp=c(1.2,0.2,0), tck=-0.01)
plot(patients, rep(NA, length(patients)), ylim=c(0,250*prabies), type="l", lwd=2, log="x", axes=FALSE,
     xlab="Monthly clinic throughput (new bite patients)",
     ylab="Direct medical costs (in USD) per patient treated")
...
lines(patients, costPRDA[3,], col="black", lwd=2)
text(100, 43, "Essen 4/ Zagreb")

# 1 week ID (blue)
polygon(c(patients, sort(patients, decreasing=T)),
        c(costPRDAwasteuci[6,], costPRDAwastelci[6,length(patients):1]),
        border=NA, col="light blue")
lines(patients, costPRDAwaste[6,], col="dark blue", lwd=2)
text(150, 34, "1 week ID", col="dark blue")

# TRC4 (dark red) - INSULIN SYRINGE
polygon(c(patients, sort(patients, decreasing=T)),
        c(costPRDAuci1insulin[1,], costPRDAlci1insulin[1,length(patients):1]),
        border=NA, col="red")
lines(patients, costPRDA1insulin[1,], col="dark red", lwd=2, lty=1)
text(150, 17, "Updated TRC", col="dark red")
...
polygon(c(patients, sort(patients, decreasing=T)),
        c(costPRDAuci1insulin[7,], costPRDAlci1insulin[7,length(patients):1]),
        border=NA, col="pink")
lines(patients, costPRDA1insulin[7,], col="indianred1", lwd=2, lty=1)
text(150, 45*prabies, "IPC", col="indianred1")
...
postscript(file="figs/costs_IDsyringe_per_patient.eps", width=4.4, height=4, horizontal=F)
par(cex=0.7, lwd=0.5, plt=c(0.35, 0.95, 0.1, 0.9), mgp=c(1.2,0.2,0), tck=-0.01)
plot(patients, rep(NA, length(patients)), ylim=c(0,250*prabies), type="l", lwd=2, log="x", axes=FALSE,
     xlab="Monthly clinic throughput (new bite patients)",
     ylab="Direct medical costs (in USD) per patient treated")
...
lines(patients, costPRDAwaste1[7,], col="indianred1", lwd=2)
text(150, 45*prabies, "IPC 1mL", col="indianred1")
...
lines(patients, costPRDA1insulin[7,], col="indianred1", lwd=2, lty=2)
lines(patients, costPRDAwaste1[7,], col="indianred1", lwd=2)
text(150, 45*prabies, "Insulin syringe", col="indianred1")
text(150, 75*prabies, "Standard syringe", col="indianred1")
dev.off()
