...
polygon(c(patients, sort(patients, decreasing=T)),
        ...
        border=NA, col="pink")
lines(patients, costPRDA[7,], col="indianred1", lwd=2)
text(150, 75, "IPC", col="indianred1")
...
# IPC (light red) - (no waste)
polygon(c(patients, sort(patients, decreasing=T)),
        c(costPRDAuci1[7,], costPRDAlci1[7,length(patients):1]),
        border=NA, col="pink")
lines(patients, costPRDA1[7,], col="indianred1", lwd=2)
...
#
# polygon(c(patients, sort(patients, decreasing=T)),
#         c(costPRDAuci1insulin[6,], costPRDAlci1insulin[6,length(patients):1]),
#         border=NA, col="indianred1")
# lines(patients, costPRDA1insulin[6,], col="dark red", lwd=2, lty=2)
#
# # # ID4 (orange), - normal syringes (waste)
# polygon(c(patients, sort(patients, decreasing=T)),
#         c(costPRDAwasteuci1[4,], costPRDAwastelci1[4,length(patients):1]),
